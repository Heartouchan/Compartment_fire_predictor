...
This program is based on the paper '_Implementation of LSTM network for generating design temperature–time curves of mass timber compartment fire_', Tongchen Han and Solomon Tesfamariam. Published in **Fire Safety Journal**.
